...
```{r}
setwd("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment")
path <- getwd()
path
...
# Unzip the file. You don't have to do it to save time.
        
```{r, eval=FALSE}
executable <- file.path("C:", "Program Files (x86)", "WinRAR", "WinRAR.exe")
parameters <- "x"
cmd <- paste(paste0("\"", executable, "\""), "x", paste0("\"", file.path(path, "Data.zip"), "\""))
system(cmd)
```
...
Training_set_Data <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/train/X_train.txt")
...
#This data is without headers so R automatically assigns them a name starting from V1 to V561 (depending on number of columns in the dataset)

#now read in the Training labels
Training_set_Label <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/train/y_train.txt")
table(Training_set_Label)
head(Training_set_Label)

#read in the subject
Training_set_subject <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/train/subject_train.txt")
table(Training_set_subject)
head(Training_set_subject)

#Now read in the Test Data
Test_set_Data <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/test/X_test.txt")
dim(Test_set_Data) 

#Test set data contains 2947 obs. with 561 columns 

#now read in the testing labels
Test_set_Label <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/test/y_test.txt")
table(Test_set_Label)
# Labels look similar as well

#now read in the testing subject
Test_set_subject <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/test/subject_test.txt")
...
features <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/features.txt")
head(features)
...
#now get the column numbers who contain the words "mean()" or "std()" using grep function
...
```{r}
activity_labels <- read.table("C:/Users/Fahad/Documents/R Projects/Coursera/Getting-and-Cleaning-Data/Peer Assessment/Data/UCI HAR Dataset/activity_labels.txt")
str(activity_labels)
